...
namespace CLADII_TextBasedAdventure
{
    public static class Utils
    {
        ...
        /// </summary>
        /// <param name="toLower">Should input be made lower case?</param>
        /// <param name="trim">Should input be trimmed, removing spaces?</param>
        /// <returns></returns>
        ...
        public static void LbL(string input, ConsoleColor color = ConsoleColor.Gray, int speed = 0, bool speedCustom = false, bool newLine = true)
        {
        ...
        public static void SwC(string input, ConsoleColor color = ConsoleColor.Gray, bool writeOrLine = false)
        {
            Console.ForegroundColor = color;
            if (writeOrLine)
            {
